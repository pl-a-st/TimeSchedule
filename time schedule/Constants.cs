...
namespace time_schedule
{
    public static class Constants
    {
        ...
        public const string PROJECT_FILE_NAME_XML = "PROJECT.xml";
        public const string PERSONS_XML = "Persons.xml";
        public const string TASKS_XML = "Tasks.xml";
        public const string HOLYDAYS_XML = "Holydays.xml";
        public const string PROGECT_TO_CHOOSE_XML = "Project to copy.xml";
